...
and the second element with \allowbreak \tcode{std::get<1>(\exposid{FWD}(\brk{}u))}.
...
\item
Otherwise, if \tcode{index() == rhs.index()},\allowbreak
...
any exception thrown by\allowbreak
...
\pnum
\remarks
If an exception is thrown during the call to function\allowbreak
\tcode{swap(std::get<$i$>(*this), std::get<$i$>(rhs))},
